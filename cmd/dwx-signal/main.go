// Command dwx-signal is the open-core core of DataWerx Signal.  It's a
// grounded natural-language question-answering layer over a running
// DataWerx mesh.
//
...
func run(args []string, stdout, stderr io.Writer) error {
	fs := flag.NewFlagSet("dwx-signal", flag.ContinueOnError)
	fs.SetOutput(stderr)
	...
	fs.Usage = func() {
		fmt.Fprintf(stderr, "Usage: dwx-signal [flags] \"<question>\"\n\n")
	...
	if *showVersion {
		fmt.Fprintf(stdout, "dwx-signal %s\n", logging.Version)
		return nil
	}
